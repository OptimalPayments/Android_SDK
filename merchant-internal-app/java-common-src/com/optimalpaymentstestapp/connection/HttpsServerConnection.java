package com.optimalpaymentstestapp.connection;
...
public class HttpsServerConnection {
	 ...
	 * @param String url
	 * @param JSONObject
	 * @param String Post and put request type
	...
	public String requestUrl(String base64EncodedCredentials, String url,JSONObject jsonObj, String requestType) {
		...
		try {
			...
			if (requestJsonData != null ) {
				...
				try {
					dataOutPutStream.write(requestJsonData.toString().getBytes("utf-8"));
			...
			e.printStackTrace();
			return getResponse(urlConnection.getErrorStream());
		} finally {
			closeConnection(urlConnection);
		}
