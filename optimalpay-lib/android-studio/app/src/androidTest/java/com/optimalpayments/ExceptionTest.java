...
public class ExceptionTest extends ApplicationTestCase<Application> {
    ...
    // Optimal Api Client Object
    private static OptimalApiClient client;
    ...
    public void testMissingOrInvalidAccount() throws Exception {
        ...
        client = new OptimalApiClient(apiKey, apiPassword, Environment.TEST);
    ...
    public void testInvalidAuthenticationCredentials() throws Exception {
        client = new OptimalApiClient("username", "password", Environment.TEST, accountNumber);
